            ...
            <div className="relative overflow-hidden border-b border-border p-6 sm:p-10 lg:border-b-0 lg:border-r">
              ...
              <div className="relative flex h-full flex-col justify-between gap-14">
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <div><p className="eyebrow">Order ID</p><p className="mt-2 font-mono text-sm font-semibold">{ticket.order_id}</p><p className="mt-1 text-sm text-muted-foreground">Rp10.000 · 1 akses</p></div>
                </div>
              </div>
            </div>
