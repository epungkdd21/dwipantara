...
import { ArrowRight, CalendarDays, Clock3, Instagram, Mail, MapPin, Menu, MessageCircle, Ticket, X } from 'lucide-react'
  ...
  return <main className={`min-h-screen overflow-hidden bg-background text-foreground ${overlayOpen ? 'scene-revealed' : ''}`}>
    ...
    <nav className="fixed inset-x-0 top-0 z-50 border-b border-accent/40 bg-primary/90 text-primary-foreground shadow-md backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 lg:px-8">
        <a href="#home" className="flex items-center gap-3"><img src={LOGO} alt="Dwipantara" className="h-10 w-10 rounded-full object-cover" /><span className="sr-only">Jagat 'Arsy Student Cabinet (JASCA) 2025/2026 — Pesantren Peradaban Dunia Jagat 'Arsy</span></a>
