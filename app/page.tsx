...
export default function Page() {
  ...
  const [form, setForm] = useState<{ name: string; email: string; whatsapp: string; quantity: string; payment_method: PaymentMethodCode | '' }>({ name: '', email: '', whatsapp: '', quantity: '1', payment_method: '' })
